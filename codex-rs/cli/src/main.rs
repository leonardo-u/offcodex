...
#[clap(
    ...
    bin_name = "offcodex",
    override_usage = "offcodex [OPTIONS] [PROMPT]\n       offcodex [OPTIONS] <COMMAND> [ARGS]"
)]
struct MultitoolCli {
    #[clap(flatten)]
...
enum Subcommand {
    ...
    /// Manage offcodex plugins.
    Plugin(PluginCli),

    /// Start offcodex as an MCP server (stdio).
